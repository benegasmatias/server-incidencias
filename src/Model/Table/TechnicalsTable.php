 ...
 * @method \App\Model\Entity\Technical saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class TechnicalsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('id_technical');
        $this->setPrimaryKey('id_technical');
    ...
    {
        $validator
            ->integer('id_technical')
            ->allowEmptyString('id_technical', null, 'create');

        $validator
            ->scalar('name_tec')
            ->maxLength('name_tec', 50)
            ->requirePresence('name_tec', 'create')
            ->notEmptyString('name_tec');
